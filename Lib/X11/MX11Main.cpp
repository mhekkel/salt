...
//MX11ApplicationImpl* MX11ApplicationImpl::sInstance = nullptr;
...
//		MGDbusServer dBusServer(url);
		...
		unique_ptr<MApplication> app(MApplication::Create(new MX11ApplicationImpl));
