...
#include "MDialog.h"
#include "MControls.h"
#include "MXcbWindowImpl.h"
#include "MError.h"
#include "MStrings.h"
#include "MXcbApplicationImpl.h"
#include "MXcbControlsImpl.h"
#include "MUtils.h"
#include "MDevice.h"
...
//class MXcbDialogImpl : public MXcbWindowImpl
//{
//  public:
//	MXcbDialogImpl(const string& inResource, MWindow* inParent)
//		: MXcbWindowImpl(MWindowFlags(0), "", inParent)
//		, mResponse(this, &MXcbDialogImpl::OnResponse)
//		, mRsrc(inResource)
//		, mResultIsOK(false)
//	{
//	}
...
//};
//
//bool MXcbDialogImpl::OnKeyPressEvent(GdkEventKey* inEvent)
//{
//	bool result = MXcbWidgetMixin::OnKeyPressEvent(inEvent);
//	
//	if (not result)
//	{
...
//}
//
//bool MXcbDialogImpl::ShowModal()
//{
//	int result = gtk_dialog_run(GTK_DIALOG(GetWidget()));
//	return mResultIsOK;
//}
//
//void MXcbDialogImpl::Create(MRect inBounds, const std::string& inTitle)
//{
...
{
//	return new MXcbDialogImpl(inResource, inWindow);
	return nullptr;
}
