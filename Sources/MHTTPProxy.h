				 ...
				 , public zeep::http::rsrc_based_webapp
{
  public:
	...
	static void InitializeProxy(assh::basic_connection* inConnection, uint16 inPort, bool require_authentication, log_level log);
	...
	assh::basic_connection* get_connection() const { return m_connection; }

  private:

	MHTTPProxy(assh::basic_connection* connection, bool require_authentication, uint32 log_flags);
	...
	assh::basic_connection* m_connection;
