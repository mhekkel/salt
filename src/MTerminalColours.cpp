...
//	// normal colours
//
//	{ uint8_t(46), uint8_t(52), uint8_t(54) },	// 0: #000000
//	{ uint8_t(204), uint8_t(0), uint8_t(0) },		// 1: #800000
//	{ uint8_t(78), uint8_t(154), uint8_t(6) },	// 2: #008000
//	{ uint8_t(128), uint8_t(128), uint8_t(0) },	// 3: #808000
//	{ uint8_t(0), uint8_t(0), uint8_t(128) },		// 4: #000080
//	{ uint8_t(128), uint8_t(0), uint8_t(128) },	// 5: #800080
//	{ uint8_t(0), uint8_t(128), uint8_t(128) },	// 6: #008080
//	{ uint8_t(192), uint8_t(192), uint8_t(192) },	// 7: #c0c0c0
//	
//	// bold colours	
//
//	{ uint8_t(128), uint8_t(128), uint8_t(128) },	// 0: #808080
//	{ uint8_t(255), uint8_t(0), uint8_t(0) },		// 1: #ff0000
//	{ uint8_t(0), uint8_t(255), uint8_t(0) },		// 2: #00ff00
//	{ uint8_t(255), uint8_t(255), uint8_t(0) },	// 3: #ffff00
//	{ uint8_t(0), uint8_t(0), uint8_t(255) },		// 4: #0000ff
//	{ uint8_t(255), uint8_t(0), uint8_t(255) },	// 5: #ff00ff
//	{ uint8_t(0), uint8_t(255), uint8_t(255) },	// 6: #00ffff
//	{ uint8_t(255), uint8_t(255), uint8_t(255) },	// 7: #ffffff
