...
//}
//
//MX11CanvasImpl::MX11CanvasImpl(MCanvas* inCanvas, uint32_t inWidth, uint32_t inHeight)
...
//}
//
//bool MX11CanvasImpl::OnMouseDown(int32_t inX, int32_t inY, uint32_t inButtonNr, uint32_t inClickCount, uint32_t inModifiers)
//{
//	bool result = false;
//	
//	// PRIMARY paste?
...
//}
//
//bool MX11CanvasImpl::OnMouseMove(int32_t inX, int32_t inY, uint32_t inModifiers)
//{
//	mControl->MouseMove(inX, inY, inModifiers);
//	return true;
//}
//
//bool MX11CanvasImpl::OnMouseUp(int32_t inX, int32_t inY, uint32_t inModifiers)
//{
