...
void MXcbButtonImpl::GetIdealSize(int32_t& outWidth, int32_t& outHeight)
{
//	outWidth = 75;
//	outHeight = 23;
//
...
//}
//
//int32_t MXcbScrollbarImpl::GetValue() const
//{
//	int32_t result = 0;
//
//	if (GetWidget() != nullptr)
...
//}
//
//void MXcbScrollbarImpl::SetValue(int32_t inValue)
//{
//	gtk_range_set_value(GTK_RANGE(GetWidget()), inValue);
//}
//
//int32_t MXcbScrollbarImpl::GetTrackValue() const
//{
//	return GetValue();
//}
//
//void MXcbScrollbarImpl::SetAdjustmentValues(int32_t inMinValue, int32_t inMaxValue,
...
//}
//
//int32_t MXcbScrollbarImpl::GetMinValue() const
//{
//	GtkAdjustment* adj = gtk_range_get_adjustment(GTK_RANGE(GetWidget()));
//	return adj == nullptr ? 0 : adj->lower;
//}
//
//int32_t MXcbScrollbarImpl::GetMaxValue() const
//{
//	GtkAdjustment* adj = gtk_range_get_adjustment(GTK_RANGE(GetWidget()));
//
//	int32_t result = 0;
...
//MXcbStatusbarImpl::MXcbStatusbarImpl(MStatusbar* inStatusbar, uint32_t inPartCount, MStatusBarElement inParts[])
...
//}
//
//void MXcbStatusbarImpl::SetStatusText(uint32_t inPartNr, const string& inText, bool inBorder)
//{
...
//}
//
//bool MXcbComboboxImpl::DispatchKeyDown(uint32_t inKeyCode, uint32_t inModifiers, bool inRepeat)
//{
//	bool result = false;
//
...
//}
//
//int32_t MXcbPopupImpl::GetValue() const
//{
//	return gtk_combo_box_get_active(GTK_COMBO_BOX(GetWidget()));
//}
//
//void MXcbPopupImpl::SetValue(int32_t inValue)
//{
...
//}
//
//bool MXcbPopupImpl::DispatchKeyDown(uint32_t inKeyCode, uint32_t inModifiers, bool inRepeat)
//{
//	bool result = false;
//
//	if (inKeyCode == kReturnKeyCode or
...
//MXcbEdittextImpl::MXcbEdittextImpl(MEdittext* inEdittext, uint32_t inFlags)
...
//}
//
//void MXcbEdittextImpl::SetPasswordChar(uint32_t inUnicode)
//{
//	GtkWidget* wdgt = GetWidget();
...
//}
//
//bool MXcbEdittextImpl::DispatchKeyDown(uint32_t inKeyCode, uint32_t inModifiers, bool inRepeat)
//{
//	bool result = false;
//
//	if (inKeyCode == kReturnKeyCode or
...
//}
//
//void MXcbNotebookImpl::SelectPage(uint32_t inPage)
//{
...
//}
//
//uint32_t MXcbNotebookImpl::GetSelectedPage() const
//{
...
//}
//
////void MXcbColorSwatchImpl::GetIdealSize(int32_t& outWidth, int32_t& outHeight)
////{
////	outWidth = 30;
////	outHeight = 23;
////
...
//}
//
//int32_t MXcbListBoxImpl::GetValue() const
//{
//	int32_t result = -1;
//	
//	GtkTreeIter iter;
...
//}
//
//void MXcbListBoxImpl::SetValue(int32_t inValue)
//{
