...
class MX11ApplicationImpl : public MApplicationImpl
{
  public:
	MX11ApplicationImpl();
	virtual ~MX11ApplicationImpl();

	static MX11ApplicationImpl& Instance()		{ return *sInstance; }
  ...
  private:
	...
	void ButtonReleaseEvent(xcb_key_release_event_t* inEvent);
...
//	static gboolean	Timeout(gpointer inData);
	static MX11ApplicationImpl* sInstance;
