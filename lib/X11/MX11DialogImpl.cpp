...
//}
//
//MView* MX11DialogImpl::CreateButton(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
...
//}
//
//MView* MX11DialogImpl::CreateColorSwatch(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
//	string id = inTemplate->get_attribute("id");
//	
...
//}
//
//MView* MX11DialogImpl::CreateExpander(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
//	string id = inTemplate->get_attribute("id");
//	string title = l(inTemplate->get_attribute("title"));
//	
...
//}
//
//MView* MX11DialogImpl::CreateCaption(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
//	string id = inTemplate->get_attribute("id");
//	if (id.empty())
//		id = "caption";
...
//}
//
//MView* MX11DialogImpl::CreateCheckbox(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
//	string id = inTemplate->get_attribute("id");
//	string title = l(inTemplate->get_attribute("title"));
//
...
//}
//
//MView* MX11DialogImpl::CreateRadiobutton(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
//	string id = inTemplate->get_attribute("id");
//	string title = l(inTemplate->get_attribute("title"));
//
...
//}
//
//MView* MX11DialogImpl::CreateCombobox(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
//	string id = inTemplate->get_attribute("id");
//
...
//}
//
//MView* MX11DialogImpl::CreateEdittext(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
//	string id = inTemplate->get_attribute("id");
//	
...
//}
//
//MView* MX11DialogImpl::CreatePopup(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
//	string id = inTemplate->get_attribute("id");
//
...
//}
//
//MView* MX11DialogImpl::CreateNotebook(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
//	string id = inTemplate->get_attribute("id");
//
//	MRect r(inX, inY, 0, 0);
...
//}
//
//MView* MX11DialogImpl::CreatePager(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
//	string id = inTemplate->get_attribute("id");
//
//	MRect r(inX, inY, 0, 0);
...
//}
//
//MView* MX11DialogImpl::CreateListBox(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
//	string id = inTemplate->get_attribute("id");
//
//	MRect r(inX, inY, 0, 0);
...
//}
//
//MView* MX11DialogImpl::CreateListView(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
//	string id = inTemplate->get_attribute("id");
//
//	MRect r(inX, inY, 0, 0);
...
//}
//
//MView* MX11DialogImpl::CreateSeparator(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
//	MRect bounds(inX, inY, 2, 2);
//	return new MSeparator("separator", bounds);
//}
//
//MView* MX11DialogImpl::CreateScrollbar(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
//	string id = inTemplate->get_attribute("id");
...
//}
//
//MView* MX11DialogImpl::CreateBox(xml::element* inTemplate, int32_t inX, int32_t inY, bool inHorizontal)
//{
//	string id = inTemplate->get_attribute("id");
//
//	uint32_t spacing = 4;
...
//}
//
//MView* MX11DialogImpl::CreateTable(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
//	string id = inTemplate->get_attribute("id");
//
//	vector<MView*> views;
...
//}
//
//MView* MX11DialogImpl::CreateControls(xml::element* inTemplate, int32_t inX, int32_t inY)
//{
...
//}
//
//uint32_t MX11DialogImpl::GetTextWidth(const string& inText,
