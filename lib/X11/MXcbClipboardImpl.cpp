...
//#include "MXcbWidgetMixin.hpp"
#include "MUtils.hpp"

using namespace std;
namespace ba = boost::algorithm;

//class MXcbClipboardImpl : public MClipboardImpl
//{
//  public:
//	MXcbClipboardImpl(MClipboard* inClipboard);
//
...
//};
//
//MXcbClipboardImpl::MXcbClipboardImpl(MClipboard* inClipboard)
//	: MClipboardImpl(inClipboard)
//	, mOwnerChange(this, &MXcbClipboardImpl::OnOwnerChange)
...
//}
//
//void MXcbClipboardImpl::LoadClipboardIfNeeded()
//{
...
//}
//
//void MXcbClipboardImpl::Reset()
//{
//}
//
//void MXcbClipboardImpl::Commit()
//{
...
//		&MXcbClipboardImpl::GtkClipboardGet, &MXcbClipboardImpl::GtkClipboardClear, this);
//	
...
//}
//
//void MXcbClipboardImpl::GtkClipboardGet(GtkClipboard* inClipboard, GtkSelectionData* inSelectionData,
//					guint inInfo, gpointer inUserDataOrOwner)
//{
//	string text;
//	bool block;
...
//}
//
//void MXcbClipboardImpl::GtkClipboardClear(GtkClipboard* inClipboard, gpointer inUserDataOrOwner)
//{
//	MXcbClipboardImpl* self = reinterpret_cast<MXcbClipboardImpl*>(inUserDataOrOwner);
//	
...
{
//	return new MXcbClipboardImpl(inClipboard);
	return nullptr;
}
